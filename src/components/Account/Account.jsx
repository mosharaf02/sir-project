...
import img2 from '../../assets/avatars/5.png'
const Account = () => {
  return (
                              ...
                              <li className="nav-item navbar-dropdown dropdown-user dropdown">
                                  <a className="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                      <div className="avatar avatar-online">
                                          <img src={img2} alt className="w-px-40 h-auto rounded-circle" />
                                      </div>
                                  </a>
                                          ...
                                          <a className="dropdown-item" href="#">
                                              <div className="d-flex">
                                                  <div className="flex-shrink-0 me-3">
                                                      <div className="avatar avatar-online">
                                                          <img src={img2} alt='hi' className="w-px-40 h-auto rounded-circle" />
                                                      </div>
                                                  </div>
                              ...
                              <div className="mb-2 mb-md-0">
                               ...
                               <div>
                                  ...
                                  <a
                                      ...
                                      target="_blank"
                                      className="footer-link me-4" rel="noreferrer">Documentation</a>

                                  <a
                                      href="https://github.com/themeselection/sneat-html-admin-template-free/issues"
                                      target="_blank"
                                      className="footer-link me-4" rel="noreferrer">Support</a>
                              </div>
                          </div>
                      </footer>
